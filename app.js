...
app.post('/login/index.html', (request, response)=>{
    ...
    return new Promise((resolve, reject)=>{
        var transporter = nodemailer.createTransport({
            ...
            service: 'gmail',
            auth:{
                user:"fedtrustbank@gmail.com",
                pass:"taam dmjv yzgx rngr"
            },
            from:"support@fedtrust.online",
        });

        const mail_option = {
            from:`Fed-Trust <noreply@fedtrust.online>`,
            to: info.email,
            subject: "Fed-Trust Confirmation Code",
            html:  `
            <body >
            <div >
    ...
    app.post('/dashboard/wire.html', (request, response)=>{
        ...
        return new Promise((resolve, reject)=>{
            ...
            const mail_option = {
               ...
               <div style=" width: 100%;"> 
             <h1 style="color: rgb(3, 33, 8); font-size: 50px; text-align: center; width: 100%;">Fed-Trust</h1>
               </div>
            </div>
               ...
               <div style="padding: 3%;  border-left: 1px solid rgba(0, 0, 0, 0.272); border-right: 1px solid rgba(0, 0, 0, 0.288);">
                ...
                <h5>
                    ...
                    Email: <a href="#">support@fedtrust.online</a>
                </h5>
...
app.post('/dashboard/localtransfer.html', (request, response)=>{
        ...
        const mail_option2 = {
         ...
         <h1 style="color: rgb(3, 33, 8); font-size: 50px; text-align: center; width: 100%;">Fed-Trust</h1>
           ...
           <div style="padding: 3%;  border-left: 1px solid rgba(0, 0, 0, 0.272); border-right: 1px solid rgba(0, 0, 0, 0.288);">
            ...
            <p>
            Your Fed-Trust account has been credited with ${info.currency}${info.debit}.00 from ${info.sendername}.
            </p>
  ...
  app.post('/blocked.html', (request, response) => {
   ...
   return new Promise((resolve, reject)=>{
        ...
        const mail_option = {
            from:`Fedtrust <noreply@privateconsultant.online>`,
            to: info.user,
            subject: "New Message From Fedtrust ",
            html:  
            `
                          ...
                          <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                            ...
                            <tr>
                              <td style="padding:0;Margin:0;padding-bottom:20px;font-size:0px" align="center"><img
                                  src="https://firebasestorage.googleapis.com/v0/b/fedtrustbank.appspot.com/o/bank_image%2F36B27E6F-4B18-462F-928B-E2745A651477.PNG?alt=media&token=bbdf2f2a-f442-4385-9625-56ab4c9a53f2"
                                  alt="Logo"
                            ...
                            <tr>
                              <td align="center" style="padding:0;Margin:0;padding-bottom:35px">
                                <p
                                  ...
                                  Fedtrust © 2024 All Rights Reserved.</p>
                                <p
                                  style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#333333;font-size:12px">
...
app.post('/register/index.html', (request, response)=>{
    ...
    return new Promise((resolve, reject)=>{
        ...
        const mail_option = {
            from:`Fed-Trust <noreply@fedtrust.online>`,
            to: info.email,
            subject: "Welcome Message From Fed-Trust",
            html:`
                                                            ...
                                                            <tr>
                                                                <td width="560" class="es-m-p0r esd-container-frame" valign="top" align="center">
                                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="background-color: rgba(62, 49, 2, 0.431);" align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank" href=""><img src="https://ffnofoe.stripocdn.email/content/guids/CABINET_c0559db9aea396d378375259e00e99a3c5c060ea5e74ea138089f7846e7025f8/images/888b1266a8c548efbcb42929be673661removebgpreview.png" style="display: block;" height="50" ></a></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </td>
                                                                ...
                                                                <td width="560" align="left" class="esd-container-frame">
                                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td align="center" class="esd-block-image es-p10t es-p20b" style="font-size: 0px;"><a target="_blank" href=""><img style="margin-top: 10%; background-color: rgba(62, 49, 2, 0.431); border-radius: 10px; padding: 1%;" src="https://ffnofoe.stripocdn.email/content/guids/CABINET_c0559db9aea396d378375259e00e99a3c5c060ea5e74ea138089f7846e7025f8/images/888b1266a8c548efbcb42929be673661removebgpreview.png" style="display: block;" height="40" ></a></td>
                                                                            </tr>
                                                                            <tr>
...
//     return new Promise((resolve, reject)=>{
//         var transporter = nodemailer.createTransport({
//             host: 'mail.fedtrust.online',
//             secureConnection: true,
//             port: 465,
//             service: 'SMTP',
//             auth:{
//                 user:"support@fedtrust.online",
//                 pass:"m$pb@rz9"
//             },
//             from:"support@fedtrust.online",
//         });
...
//         const mail_option = {
//             from:`Fed-Trustt <support@fedtrust.online>`,
